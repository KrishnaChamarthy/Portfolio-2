      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-8 animate-fade-in-up">
          <Link 
            ...
            className="inline-flex items-center space-x-2 px-6 py-3 bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-lg hover:border-yellow-500/50 hover:bg-yellow-900/20 transition-all duration-300"
          >
        ...
        <div className="mb-16 animate-fade-in-up delay-400">
          <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 hover:border-yellow-500/50 hover:bg-yellow-900/10 transition-all duration-300">
        ...
        <div className="mb-16 animate-fade-in-up delay-500">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {techStack.map((tech, index) => (
              <div key={index} className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 hover:border-yellow-500/50 hover:bg-yellow-900/10 transition-all duration-300">
                <h3 className="text-xl font-semibold text-yellow-400 mb-4">{tech.category}</h3>
                <div className="flex flex-wrap gap-2">
                  {tech.items.map((item, itemIndex) => (
                    <span key={itemIndex} className="px-3 py-1 bg-yellow-900/30 border border-yellow-500/30 rounded-full text-sm text-gray-300">
                      {item}
                    </span>
                  ))}
                </div>
        ...
        <div className="mb-16 animate-fade-in-up delay-700">
          ...
          <div className="border border-gray-700/50 rounded-2xl p-8 hover:border-yellow-500/50 transition-all duration-300">
              ...
              <div key={index} className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 hover:border-yellow-500/50 hover:bg-yellow-900/10 transition-all duration-300">
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {component.technologies.map((tech, techIndex) => (
                    <span key={techIndex} className="px-2 py-1 bg-yellow-900/30 border border-yellow-500/30 rounded-full text-xs text-yellow-300">
                      {tech}
                    </span>
                  ))}
                </div>
        ...
        <div className="mb-16 animate-fade-in-up delay-1000">
          <div className="bg-gradient-to-r from-yellow-900/20 to-orange-900/20 backdrop-blur-sm border border-yellow-500/30 rounded-2xl p-8">
